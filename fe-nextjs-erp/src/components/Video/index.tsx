      ...
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            ...
            paragraph="Jangan cuma percaya kata-kata kami. Tonton video singkat ini untuk melihat bagaimana tim Create.tif menyulap produk biasa menjadi konten digital yang estetik dan viral."
            center
            mb="80px"
          />
        </div>
