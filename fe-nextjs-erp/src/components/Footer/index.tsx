      ...
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Partner digital kreatif untuk UMKM Indonesia. Kami membantu bisnismu tampil profesional lewat Website, Filter AR, dan Fotografi Produk yang memukau.
                </p>
                <div className="flex items-center">
                  {/* Social Icons (Biarkan default dulu, nanti diganti link sosmed asli) */}
                  <a
                  ...
                  >
                     {/* Instagram Icon placeholder (using the existing LinkedIn SVG slot for now or keep generic) */}
            ...
            {/* Kolom 3: Layanan (Ganti Terms jadi Layanan biar lebih guna) */}
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">
                  Layanan
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              &copy; {new Date().getFullYear()} Create.tif. All rights reserved. 
              <span className="hidden md:inline"> | Dibuat untuk UMKM Indonesia.</span>
            </p>
          </div>
        </div>
        
        {/* Decorative Shapes (Tetap dipertahankan biar estetik) */}
